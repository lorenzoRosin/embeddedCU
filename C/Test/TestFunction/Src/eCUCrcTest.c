...
void crc32TestBadPointer(void)
{
    ...
    /* Function */
    if( CRC_RES_BADPOINTER == crc32Seed(0u, NULL, 1u, &crc32SValTest) )
    {
    ...
    if( CRC_RES_BADPOINTER == crc32Seed(0u, crc8SValTest, 1u, NULL) )
    {
    ...
    if( CRC_RES_BADPOINTER == crc32(NULL, 1u, &crc32SValTest) )
    {
    ...
    if( CRC_RES_BADPOINTER == crc32(crc8SValTest, 1u, NULL) )
    {
...
void crc32TestCombined(void)
{
    ...
    if( CRC_RES_OK == crc32Seed(crcTestValSeedC, crcTestDataC, sizeof(crcTestDataC), &crcTestValRetC) )
    {
    ...
    crcTestValSeedC = 0xFFFFFFFFu;
    if( CRC_RES_OK == crc32Seed(crcTestValSeedC, crcTestDataC, 0x03u, &crcTestValRetC) )
    {
    ...
    if( CRC_RES_OK == crc32Seed(crcTestValSeedC, crcTestDataC2, 0x03u, &crcTestValRetC) )
    {
        if( 0x9FE54C6Du == crcTestValRetC)
        {
            (void)printf("crc32TestCombined 1  -- OK \n");
